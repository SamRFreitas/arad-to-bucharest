...
// /* Construtor de grafo personalizado para o problema.
// Não há necessidade de fazer função específicas de grafos.
// Por exemplo: inserir à esq, inserir à dir, etc.
// */
// public Grafo() {
// /* Criar ciadades do mapa
// Os valores numéricos representam as heuríticas para a
// cidade que será o destino final. Distância em linha reta.
// */
